...
GP5d_inh_all_down <- read_tsv("data/TEs/GP5d_DNMTi_HDACi_Downregulated.bed", col_names = c(bed_colnames[1:4], "family", "class"))
...
GP5d_inh_all_up <- read_tsv("data/TEs/GP5d_DNMTi_HDACi_Upregulated.bed", col_names = c(bed_colnames[1:4], "family", "class"))
